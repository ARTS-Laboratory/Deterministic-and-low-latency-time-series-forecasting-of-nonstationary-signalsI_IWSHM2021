...
np.savetxt("data/MLP_2_C_0.csv", coef[0], delimiter=",")
np.savetxt("data/MLP_2_C_1.csv", np.expand_dims(coef[1][:,0],axis=0), delimiter=",")
np.savetxt("data/MLP_2_B_0.csv", np.expand_dims(intercept[0],axis=0), delimiter=",")
np.savetxt("data/MLP_2_B_1.csv", intercept[1], delimiter=",")
np.savetxt("data/MLP_2_xx.csv", np.expand_dims(xx,axis=0), delimiter=",")
